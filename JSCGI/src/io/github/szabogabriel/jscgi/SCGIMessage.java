...
public class SCGIMessage {
	 ...
	 * 
	 * @param headers a {@link java.util.Map} holding the HTTP headers.
	 ...
	 * server.
	 * 
	 * @param in the {@link java.io.InputStream} to be used as source.
	 * @throws IOException
	 */
	 ...
	 * 
	 * @return {@link java.util.Map} holding the header attributes.
	 */
	...
	/**
	 * Convenience method setting the {@link java.util.Map} holding the header
	...
	/**
	 * Write this SCGI message to the {@link java.io.OutputStream} provided as a
	 * attribute.
	 * 
	 * @param out
	 * @throws IOException
